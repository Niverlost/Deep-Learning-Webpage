...
Paper-faithful implementation of DeiT-Base/16 (distilled variant).
DeiT-Base is architecturally identical to ViT-Base, with the addition of a
distillation token and a separate distillation head.
"""
...
NUM_PREFIX_TOKENS = 2
NUM_TOKENS = NUM_PATCHES + NUM_PREFIX_TOKENS
