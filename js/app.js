...
// ============================================================
// Viz-Page Functions (ported from test)
// ============================================================
...
function renderInfoPage(m, container, modeToggleHtml) {
  container.innerHTML = `
    ...
    ${m.paperUrl || m.paper ? `
    <div class="model-page-section">
      <a href="${escapeHtml(m.paperUrl || m.paper)}" target="_blank" rel="noopener" class="btn btn-secondary">论文链接</a>
    </div>
    ` : ''}
  `;
}
...
function onBlockClick(blockId) {
  ...
  const config = typeof VIZ_CONFIGS !== 'undefined' ? VIZ_CONFIGS[modelName] : null;
