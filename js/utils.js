...
export class ErrorCollector {
  ...
  saveErrors() {
    try {
      localStorage.setItem(this.key, JSON.stringify(this.errors.slice(-this.maxSize)));
    } catch {}
  }
...
export class PerformanceMonitor {
  ...
  report() {
    return { ...this.metrics, url: location.href, timestamp: Date.now() };
  }
}
