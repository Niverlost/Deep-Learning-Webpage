  ...
  'ResNet-50': {
    ...
    blocks: [
      ...
      { id: 'stem', type: 'custom', label: 'Stem', desc: 'Conv 64@7×7 + BN + ReLU + MaxPool', icon: LUCIDE_ICONS['🔧'],
        detail: 'Conv 64@7×7(stride=2) → BatchNorm → ReLU → MaxPool 3×3(stride=2)，输出 56×56×64',
        children: [
          { id: 'stem_conv', type: 'conv', label: 'Conv 7×7', desc: 'Conv 64@7×7, stride 2', params: { in_ch: 3, out_ch: 64, kernel: 7, stride: 2, norm: 'batch', act: 'ReLU' } },
          { id: 'stem_bn', type: 'norm', label: 'BatchNorm', desc: 'BatchNorm2d(64)' },
          { id: 'stem_act', type: 'activation', label: 'ReLU', desc: 'ReLU 激活' },
          { id: 'stem_pool', type: 'pool', label: 'MaxPool', desc: 'MaxPool 3×3, stride 2', params: { pool: 'max', pool_size: 3, stride: 2 } }
        ]},
      { id: 'layer1', type: 'custom', label: 'Layer 1 (conv2_x)', desc: '3× Bottleneck, 64→256, 56×56', icon: LUCIDE_ICONS['📦'],
        ...
        children: [
          ...
          { id: 'l1_b2', type: 'custom', label: 'Bottleneck 2', desc: '1×1(64)→3×3(64)→1×1(256) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l1b2_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 64@1×1 + BN + ReLU', params: { in_ch: 256, out_ch: 64, kernel: 1, norm: 'batch', act: 'ReLU' } },
              { id: 'l1b2_3x3', type: 'conv', label: '3×3 Conv', desc: 'Conv 64@3×3 + BN + ReLU', params: { in_ch: 64, out_ch: 64, kernel: 3, norm: 'batch', act: 'ReLU' } },
              { id: 'l1b2_out', type: 'conv', label: '1×1 Conv', desc: 'Conv 256@1×1 + BN (+shortcut)', params: { in_ch: 64, out_ch: 256, kernel: 1, norm: 'batch' } }
            ]},
          { id: 'l1_b3', type: 'custom', label: 'Bottleneck 3', desc: '1×1(64)→3×3(64)→1×1(256) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l1b3_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 64@1×1 + BN + ReLU', params: { in_ch: 256, out_ch: 64, kernel: 1, norm: 'batch', act: 'ReLU' } },
              { id: 'l1b3_3x3', type: 'conv', label: '3×3 Conv', desc: 'Conv 64@3×3 + BN + ReLU', params: { in_ch: 64, out_ch: 64, kernel: 3, norm: 'batch', act: 'ReLU' } },
              { id: 'l1b3_out', type: 'conv', label: '1×1 Conv', desc: 'Conv 256@1×1 + BN (+shortcut)', params: { in_ch: 64, out_ch: 256, kernel: 1, norm: 'batch' } }
            ]}
        ]},
      { id: 'layer2', type: 'custom', label: 'Layer 2 (conv3_x)', desc: '4× Bottleneck, 256→512, 28×28', icon: LUCIDE_ICONS['📦'],
        detail: '4 个 Bottleneck 残差块，第一个 stride=2 下采样，通道 256→512，尺寸 28×28',
        children: [
          { id: 'l2_b1', type: 'custom', label: 'Bottleneck 1 (stride=2)', desc: '1×1(128)→3×3(128)→1×1(512) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l2b1_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 128@1×1 + BN + ReLU', params: { in_ch: 256, out_ch: 128, kernel: 1, norm: 'batch', act: 'ReLU' } },
          ...
          { id: 'l2_b2', type: 'custom', label: 'Bottleneck 2', desc: '1×1(128)→3×3(128)→1×1(512) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l2b2_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 128@1×1 + BN + ReLU', params: { in_ch: 512, out_ch: 128, kernel: 1, norm: 'batch', act: 'ReLU' } },
              { id: 'l2b2_3x3', type: 'conv', label: '3×3 Conv', desc: 'Conv 128@3×3 + BN + ReLU', params: { in_ch: 128, out_ch: 128, kernel: 3, norm: 'batch', act: 'ReLU' } },
              { id: 'l2b2_out', type: 'conv', label: '1×1 Conv', desc: 'Conv 512@1×1 + BN (+shortcut)', params: { in_ch: 128, out_ch: 512, kernel: 1, norm: 'batch' } }
            ]},
          { id: 'l2_b3', type: 'custom', label: 'Bottleneck 3', desc: '1×1(128)→3×3(128)→1×1(512) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l2b3_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 128@1×1 + BN + ReLU', params: { in_ch: 512, out_ch: 128, kernel: 1, norm: 'batch', act: 'ReLU' } },
              { id: 'l2b3_3x3', type: 'conv', label: '3×3 Conv', desc: 'Conv 128@3×3 + BN + ReLU', params: { in_ch: 128, out_ch: 128, kernel: 3, norm: 'batch', act: 'ReLU' } },
              { id: 'l2b3_out', type: 'conv', label: '1×1 Conv', desc: 'Conv 512@1×1 + BN (+shortcut)', params: { in_ch: 128, out_ch: 512, kernel: 1, norm: 'batch' } }
            ]},
          { id: 'l2_b4', type: 'custom', label: 'Bottleneck 4', desc: '1×1(128)→3×3(128)→1×1(512) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l2b4_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 128@1×1 + BN + ReLU', params: { in_ch: 512, out_ch: 128, kernel: 1, norm: 'batch', act: 'ReLU' } },
              { id: 'l2b4_3x3', type: 'conv', label: '3×3 Conv', desc: 'Conv 128@3×3 + BN + ReLU', params: { in_ch: 128, out_ch: 128, kernel: 3, norm: 'batch', act: 'ReLU' } },
              { id: 'l2b4_out', type: 'conv', label: '1×1 Conv', desc: 'Conv 512@1×1 + BN (+shortcut)', params: { in_ch: 128, out_ch: 512, kernel: 1, norm: 'batch' } }
            ]}
        ]},
      { id: 'layer3', type: 'custom', label: 'Layer 3 (conv4_x)', desc: '6× Bottleneck, 512→1024, 14×14', icon: LUCIDE_ICONS['📦'],
        detail: '6 个 Bottleneck 残差块，第一个 stride=2 下采样，通道 512→1024，尺寸 14×14',
        children: [
          { id: 'l3_b1', type: 'custom', label: 'Bottleneck 1 (stride=2)', desc: '1×1(256)→3×3(256)→1×1(1024) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l3b1_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 256@1×1 + BN + ReLU', params: { in_ch: 512, out_ch: 256, kernel: 1, norm: 'batch', act: 'ReLU' } },
      ...
      { id: 'layer4', type: 'custom', label: 'Layer 4 (conv5_x)', desc: '3× Bottleneck, 1024→2048, 7×7', icon: LUCIDE_ICONS['📦'],
        detail: '3 个 Bottleneck 残差块，第一个 stride=2 下采样，通道 1024→2048，尺寸 7×7',
        children: [
          { id: 'l4_b1', type: 'custom', label: 'Bottleneck 1 (stride=2)', desc: '1×1(512)→3×3(512)→1×1(2048) + shortcut', icon: LUCIDE_ICONS['🔗'],
            children: [
              { id: 'l4b1_1x1', type: 'conv', label: '1×1 Conv', desc: 'Conv 512@1×1 + BN + ReLU', params: { in_ch: 1024, out_ch: 512, kernel: 1, norm: 'batch', act: 'ReLU' } },
      ...
      { id: 'avgpool', type: 'pool', label: 'Global AvgPool', desc: 'AdaptiveAvgPool 1×1', params: { pool: 'avg', pool_size: 1, global: true }, detail: '全局平均池化，将 7×7 特征图压缩为 1×1' },
      { id: 'fc', type: 'linear', label: 'FC', desc: 'Linear 2048→1000', params: { in_f: 2048, out_f: 1000 }, detail: '全连接层输出 1000 类' },
      { id: 'output', type: 'output', label: 'Output', desc: 'Softmax 1000类', detail: '输出 1000 维分类概率分布' }
    ],
    connections: [
      ['input', 'stem'], ['stem', 'layer1'], ['layer1', 'layer2'], ['layer2', 'layer3'], ['layer3', 'layer4'], ['layer4', 'avgpool'], ['avgpool', 'fc'], ['fc', 'output']
    ],
    code: `import torch
...
# 前向传播
with torch.no_grad():
    output = model(input_tensor)  # input_tensor: [B, 3, 224, 224]
    probs = torch.softmax(output, dim=1)`,
    mermaid: `graph LR
    Input[Input 224x224x3] --> Stem[Stem Conv7x7]
    Stem --> L1[Layer1 3xBottleneck]
    L1 --> L2[Layer2 4xBottleneck]
    L2 --> L3[Layer3 6xBottleneck]
    L3 --> L4[Layer4 3xBottleneck]
    L4 --> GAP[Global AvgPool]
    GAP --> FC[FC 1000]
    FC --> Output[Output]`
  },
  ...
  'VGG-16': {
    ...
    blocks: [
      { id: 'input', type: 'input', label: 'Input', desc: '224×224×3 RGB图像', detail: '输入为 224×224 的三通道 RGB 图像' },
      { id: 'block1', type: 'custom', label: 'Block 1', desc: '2× Conv 64@3×3 + ReLU + MaxPool', icon: LUCIDE_ICONS['📦'],
        detail: '两个 3×3 卷积(64通道) → ReLU → MaxPool 2×2，输出 112×112×64',
        children: [
          { id: 'b1_conv1', type: 'conv', label: 'Conv 64@3×3', desc: 'Conv + ReLU', params: { in_ch: 3, out_ch: 64, kernel: 3, act: 'ReLU' } },
          { id: 'b1_conv2', type: 'conv', label: 'Conv 64@3×3', desc: 'Conv + ReLU', params: { in_ch: 64, out_ch: 64, kernel: 3, act: 'ReLU' } },
          { id: 'b1_pool', type: 'pool', label: 'MaxPool 2×2', desc: '下采样', params: { pool: 'max', pool_size: 2 } }
        ]},
      { id: 'block2', type: 'custom', label: 'Block 2', desc: '2× Conv 128@3×3 + ReLU + MaxPool', icon: LUCIDE_ICONS['📦'],
        detail: '两个 3×3 卷积(128通道) → ReLU → MaxPool 2×2，输出 56×56×128',
        children: [
          { id: 'b2_conv1', type: 'conv', label: 'Conv 128@3×3', desc: 'Conv + ReLU', params: { in_ch: 64, out_ch: 128, kernel: 3, act: 'ReLU' } },
          { id: 'b2_conv2', type: 'conv', label: 'Conv 128@3×3', desc: 'Conv + ReLU', params: { in_ch: 128, out_ch: 128, kernel: 3, act: 'ReLU' } },
          { id: 'b2_pool', type: 'pool', label: 'MaxPool 2×2', desc: '下采样', params: { pool: 'max', pool_size: 2 } }
        ]},
      { id: 'block3', type: 'custom', label: 'Block 3', desc: '3× Conv 256@3×3 + ReLU + MaxPool', icon: LUCIDE_ICONS['📦'],
        detail: '三个 3×3 卷积(256通道) → ReLU → MaxPool 2×2，输出 28×28×256',
        children: [
          { id: 'b3_conv1', type: 'conv', label: 'Conv 256@3×3', desc: 'Conv + ReLU', params: { in_ch: 128, out_ch: 256, kernel: 3, act: 'ReLU' } },
          { id: 'b3_conv2', type: 'conv', label: 'Conv 256@3×3', desc: 'Conv + ReLU', params: { in_ch: 256, out_ch: 256, kernel: 3, act: 'ReLU' } },
          { id: 'b3_conv3', type: 'conv', label: 'Conv 256@3×3', desc: 'Conv + ReLU', params: { in_ch: 256, out_ch: 256, kernel: 3, act: 'ReLU' } },
          { id: 'b3_pool', type: 'pool', label: 'MaxPool 2×2', desc: '下采样', params: { pool: 'max', pool_size: 2 } }
        ]},
      { id: 'block4', type: 'custom', label: 'Block 4', desc: '3× Conv 512@3×3 + ReLU + MaxPool', icon: LUCIDE_ICONS['📦'],
        detail: '三个 3×3 卷积(512通道) → ReLU → MaxPool 2×2，输出 14×14×512',
        children: [
          { id: 'b4_conv1', type: 'conv', label: 'Conv 512@3×3', desc: 'Conv + ReLU', params: { in_ch: 256, out_ch: 512, kernel: 3, act: 'ReLU' } },
          { id: 'b4_conv2', type: 'conv', label: 'Conv 512@3×3', desc: 'Conv + ReLU', params: { in_ch: 512, out_ch: 512, kernel: 3, act: 'ReLU' } },
          { id: 'b4_conv3', type: 'conv', label: 'Conv 512@3×3', desc: 'Conv + ReLU', params: { in_ch: 512, out_ch: 512, kernel: 3, act: 'ReLU' } },
          { id: 'b4_pool', type: 'pool', label: 'MaxPool 2×2', desc: '下采样', params: { pool: 'max', pool_size: 2 } }
        ]},
      { id: 'block5', type: 'custom', label: 'Block 5', desc: '3× Conv 512@3×3 + ReLU + MaxPool', icon: LUCIDE_ICONS['📦'],
        detail: '三个 3×3 卷积(512通道) → ReLU → MaxPool 2×2，输出 7×7×512',
        children: [
          { id: 'b5_conv1', type: 'conv', label: 'Conv 512@3×3', desc: 'Conv + ReLU', params: { in_ch: 512, out_ch: 512, kernel: 3, act: 'ReLU' } },
          { id: 'b5_conv2', type: 'conv', label: 'Conv 512@3×3', desc: 'Conv + ReLU', params: { in_ch: 512, out_ch: 512, kernel: 3, act: 'ReLU' } },
          { id: 'b5_conv3', type: 'conv', label: 'Conv 512@3×3', desc: 'Conv + ReLU', params: { in_ch: 512, out_ch: 512, kernel: 3, act: 'ReLU' } },
          { id: 'b5_pool', type: 'pool', label: 'MaxPool 2×2', desc: '下采样', params: { pool: 'max', pool_size: 2 } }
        ]},
      { id: 'flatten', type: 'custom', label: 'Flatten', desc: '展平 7×7×512=25088', icon: LUCIDE_ICONS['📊'], detail: '将特征图展平为一维向量' },
      { id: 'fc1', type: 'mlp', label: 'FC1', desc: 'Linear 25088→4096 + ReLU + Dropout', params: { in_f: 25088, out_f: 4096, act: 'ReLU', dropout: 0.5 }, detail: '全连接层 + ReLU + Dropout(0.5)' },
      { id: 'fc2', type: 'mlp', label: 'FC2', desc: 'Linear 4096→4096 + ReLU + Dropout', params: { in_f: 4096, out_f: 4096, act: 'ReLU', dropout: 0.5 }, detail: '全连接层 + ReLU + Dropout(0.5)' },
      { id: 'fc3', type: 'linear', label: 'FC3', desc: 'Linear 4096→1000', params: { in_f: 4096, out_f: 1000 }, detail: '输出层' },
      { id: 'output', type: 'output', label: 'Output', desc: 'Softmax 1000类', detail: '输出 1000 维分类概率分布' }
    ],
    connections: [
      ['input', 'block1'], ['block1', 'block2'], ['block2', 'block3'], ['block3', 'block4'], ['block4', 'block5'], ['block5', 'flatten'], ['flatten', 'fc1'], ['fc1', 'fc2'], ['fc2', 'fc3'], ['fc3', 'output']
    ],
    code: `import torch
import torch.nn as nn
import torchvision.models as models
...
with torch.no_grad():
    ...
    probs = torch.softmax(output, dim=1)`,
    mermaid: `graph LR
    Input[Input 224x224x3] --> B1[Block1 2xConv64]
    B1 --> B2[Block2 2xConv128]
    B2 --> B3[Block3 3xConv256]
    B3 --> B4[Block4 3xConv512]
    B4 --> B5[Block5 3xConv512]
    B5 --> Flat[Flatten]
    Flat --> FC1[FC1 4096]
    FC1 --> FC2[FC2 4096]
    FC2 --> FC3[FC3 1000]
  ...
  'Transformer': {
    ...
    blocks: [
      { id: 'input', type: 'input', label: 'Input', desc: 'Token 序列 + 位置编码', detail: '输入为 Token Embedding + Positional Encoding 的序列' },
      { id: 'embedding', type: 'linear', label: 'Embedding', desc: 'Token Embedding + Positional Encoding', params: { in_f: 30000, out_f: 512 }, detail: '词表映射到 d_model 维向量，加上位置编码' },
      { id: 'encoder', type: 'custom', label: 'Encoder ×N', desc: 'N 层编码器堆叠', icon: LUCIDE_ICONS['📦'],
        detail: 'N 个相同的编码器层堆叠，每层包含 Multi-Head Self-Attention 和 Feed-Forward Network',
        children: [
          { id: 'enc_mha', type: 'attention', label: 'Multi-Head Self-Attention', desc: 'Q, K, V = Linear → Scaled Dot-Product Attention → Concat → Linear',
            detail: '将输入映射为 Q、K、V 三个矩阵，分头计算注意力 → 拼接 → 线性变换。Attention(Q,K,V) = softmax(QK^T/√d_k)V' },
          { id: 'enc_addnorm1', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + MultiHeadAttention(x))' },
          { id: 'enc_ffn', type: 'mlp', label: 'Feed-Forward Network', desc: 'Linear(d_model, d_ff) → ReLU → Linear(d_ff, d_model)',
            params: { in_f: 512, out_f: 2048, act: 'ReLU' },
            detail: '两层全连接网络：先升维到 d_ff，再降维回 d_model，中间加 ReLU 激活' },
          { id: 'enc_addnorm2', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + FFN(x))' }
        ]},
      { id: 'decoder', type: 'custom', label: 'Decoder ×N', desc: 'N 层解码器堆叠', icon: LUCIDE_ICONS['📦'],
        detail: 'N 个相同的解码器层，比编码器多一个 Cross-Attention 子层',
        children: [
          { id: 'dec_masked_mha', type: 'attention', label: 'Masked Self-Attention', desc: '带因果掩码的自注意力', detail: '防止解码器看到未来位置的信息，通过 mask 将未来位置的注意力分数设为 -∞' },
          { id: 'dec_addnorm1', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + MaskedMHA(x))' },
          { id: 'dec_cross_mha', type: 'attention', label: 'Cross-Attention', desc: 'Q=decoder, K/V=encoder output', detail: 'Q 来自解码器，K 和 V 来自编码器输出，实现编码器-解码器注意力' },
          { id: 'dec_addnorm2', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + CrossAttention(x))' },
          { id: 'dec_ffn', type: 'mlp', label: 'Feed-Forward Network', desc: 'Linear → ReLU → Linear', params: { in_f: 512, out_f: 2048, act: 'ReLU' }, detail: '与编码器相同的 FFN 结构' },
          { id: 'dec_addnorm3', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + FFN(x))' }
        ]},
      { id: 'linear', type: 'linear', label: 'Linear', desc: 'Linear(d_model, vocab_size)', params: { in_f: 512, out_f: 30000 }, detail: '投影到词表大小' },
      { id: 'softmax', type: 'activation', label: 'Softmax', desc: 'Softmax', detail: '输出概率分布' },
      { id: 'output', type: 'output', label: 'Output', desc: 'Token 概率分布', detail: '输出下一个 token 的概率分布' }
    ],
    connections: [
      ['input', 'embedding'], ['embedding', 'encoder'], ['encoder', 'decoder'], ['decoder', 'linear'], ['linear', 'softmax'], ['softmax', 'output']
    ],
    code: `import torch
import torch.nn as nn

class Transformer(nn.Module):
    def __init__(self, d_model=512, nhead=8, num_layers=6, dim_ff=2048, vocab_size=30000):
        super().__init__()
    ...
    def forward(self, src, tgt):
        ...
        return self.fc(out)`,
    mermaid: `graph LR
    Input[Input Tokens] --> Emb[Embedding + PosEnc]
    Emb --> Enc[Encoder x6]
    Enc --> Dec[Decoder x6]
    Dec --> Linear[Linear]
  ...
  'BERT': {
    ...
    blocks: [
      { id: 'input', type: 'input', label: 'Input', desc: 'Token + Segment + Position Embedding', detail: 'Token Embedding + Segment Embedding(区分句子A/B) + Position Embedding → 求和' },
      { id: 'embedding', type: 'custom', label: 'Embeddings', desc: 'Token + Segment + Position', icon: LUCIDE_ICONS['📝'],
        detail: '三种嵌入求和：Token Embedding(30522×768) + Segment Embedding(2×768) + Position Embedding(512×768)',
        children: [
          { id: 'tok_emb', type: 'linear', label: 'Token Embedding', desc: '30522 × 768', params: { in_f: 30522, out_f: 768 }, detail: 'Token 嵌入' },
          { id: 'seg_emb', type: 'linear', label: 'Segment Embedding', desc: '2 × 768', params: { in_f: 2, out_f: 768 }, detail: '句子分段嵌入' },
          { id: 'pos_emb', type: 'linear', label: 'Position Embedding', desc: '512 × 768', params: { in_f: 512, out_f: 768 }, detail: '位置嵌入' }
        ]},
      { id: 'encoder', type: 'custom', label: 'Transformer Encoder ×12', desc: '12 层 Transformer Encoder', icon: LUCIDE_ICONS['📦'],
        detail: '12 层相同的 Transformer Encoder 块堆叠',
        children: [
          { id: 'enc_mha', type: 'attention', label: 'Multi-Head Self-Attention', desc: '12头注意力', detail: '双向自注意力，可以同时关注上下文信息' },
          { id: 'enc_addnorm1', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + Attention(x))' },
          { id: 'enc_ffn', type: 'mlp', label: 'Feed-Forward', desc: 'Linear(768, 3072) → GELU → Linear(3072, 768)', params: { in_f: 768, out_f: 3072, act: 'GELU' }, detail: 'GELU 激活的前馈网络' },
          { id: 'enc_addnorm2', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + FFN(x))' }
        ]},
      { id: 'pooler', type: 'custom', label: 'Pooler', desc: '取 [CLS] 输出 → Tanh', icon: LUCIDE_ICONS['🏊'],
        detail: '取第一个 [CLS] token 的输出，经过 Tanh 激活得到句子表示',
        children: [
          { id: 'pooler_linear', type: 'linear', label: 'Linear', desc: 'Linear(768, 768)', params: { in_f: 768, out_f: 768 }, detail: '全连接层' },
          { id: 'pooler_tanh', type: 'activation', label: 'Tanh', desc: 'Tanh 激活', detail: 'Tanh 激活函数' }
        ]},
      { id: 'cls_head', type: 'custom', label: 'Classification Head', desc: '分类头', icon: LUCIDE_ICONS['🎯'],
        detail: '根据下游任务设计的分类头',
        children: [
          { id: 'cls_dropout', type: 'dropout', label: 'Dropout', desc: 'Dropout 0.1', params: { rate: 0.1 }, detail: 'Dropout 正则化' },
          { id: 'cls_linear', type: 'linear', label: 'Linear', desc: 'Linear(768, num_classes)', params: { in_f: 768, out_f: 2 }, detail: '全连接分类层' }
        ]},
      { id: 'output', type: 'output', label: 'Output', desc: '分类概率', detail: '输出分类概率分布' }
    ],
    connections: [
      ['input', 'embedding'], ['embedding', 'encoder'], ['encoder', 'pooler'], ['pooler', 'cls_head'], ['cls_head', 'output']
    ],
...
with torch.no_grad():
    ...
    mermaid: `graph LR
    Input[Input Tokens] --> Emb[Embeddings]
    Emb --> Enc[Transformer Encoder x12]
    Enc --> Pooler[Pooler CLS]
    Pooler --> CLS[Classification Head]
    CLS --> Output[Output]`
  },
  ...
  'YOLOv5': {
    ...
    dataType: '图像',
    params: {
      variant: { label: '变体', type: 'select', options: ['YOLOv5n', 'YOLOv5s', 'YOLOv5m', 'YOLOv5l', 'YOLOv5x'], default: 'YOLOv5s' },
      numClasses: { label: '检测类别数', min: 1, max: 100, default: 80, step: 1 }
    },
    blocks: [
      { id: 'input', type: 'input', label: 'Input', desc: '640×640×3 RGB图像', detail: '输入为 640×640 的三通道 RGB 图像' },
      { id: 'focus', type: 'conv', label: 'Focus', desc: '切片 + Conv 32@3×3', params: { in_ch: 3, out_ch: 32, kernel: 3 }, detail: 'Focus 模块：使用切片操作将图像下采样' },
      { id: 'cspdarknet', type: 'custom', label: 'CSPDarknet', desc: 'CSP骨干网络', icon: LUCIDE_ICONS['🏗️'],
        detail: 'Cross Stage Partial 骨干网络，增强梯度流同时减少计算量',
        children: [
          { id: 'csp_stage1', type: 'custom', label: 'CSP Stage 1', desc: 'Conv + C3 + MaxPool', icon: LUCIDE_ICONS['📦'], detail: 'CSP Stage 1，输出 128 通道' },
      ...
      { id: 'sppf', type: 'custom', label: 'SPPF', desc: '空间金字塔池化', icon: LUCIDE_ICONS['🔺'],
        detail: 'Spatial Pyramid Pooling - Fast：多次 MaxPool 的串行版本',
        children: [
          { id: 'sppf_conv', type: 'conv', label: 'Conv 1×1', desc: 'Conv 1024@1×1', params: { in_ch: 1024, out_ch: 512, kernel: 1 }, detail: '1×1 卷积降维' },
          { id: 'sppf_pool1', type: 'pool', label: 'MaxPool 5×5', desc: 'MaxPool 5×5', params: { pool: 'max', pool_size: 5 }, detail: '5×5 最大池化' },
          { id: 'sppf_pool2', type: 'pool', label: 'MaxPool 5×5', desc: 'MaxPool 5×5', params: { pool: 'max', pool_size: 5 }, detail: '5×5 最大池化' },
          { id: 'sppf_pool3', type: 'pool', label: 'MaxPool 5×5', desc: 'MaxPool 5×5', params: { pool: 'max', pool_size: 5 }, detail: '5×5 最大池化' },
          { id: 'sppf_concat', type: 'custom', label: 'Concat', desc: '拼接', icon: LUCIDE_ICONS['🔗'], detail: '拼接多个尺度特征' }
        ]},
      { id: 'pan', type: 'custom', label: 'PAN+FPN', desc: '路径聚合网络', icon: LUCIDE_ICONS['🔺'],
        detail: 'Path Aggregation Network + Feature Pyramid Network：双向特征金字塔',
        children: [
      ...
      { id: 'yolo_head', type: 'custom', label: 'YOLO Head', desc: '解耦头 (Anchor-free)', icon: LUCIDE_ICONS['🎯'],
        ...
        children: [
          { id: 'yh_cls', type: 'conv', label: '分类分支', desc: 'Conv + Sigmoid', params: { act: 'Sigmoid' }, detail: '分类置信度预测' },
          { id: 'yh_reg', type: 'conv', label: '回归分支', desc: 'Conv', detail: '边界框回归（中心+宽高）' },
          { id: 'yh_obj', type: 'conv', label: '置信度分支', desc: 'Conv + Sigmoid', params: { act: 'Sigmoid' }, detail: '目标置信度预测' }
        ]},
      { id: 'nms', type: 'custom', label: 'NMS', desc: '非极大值抑制', icon: LUCIDE_ICONS['⚙️'], detail: '过滤重叠检测框' },
      { id: 'output', type: 'output', label: 'Output', desc: '检测框 + 类别 + 置信度', detail: '输出目标检测结果' }
    ],
    connections: [
      ['input', 'focus'], ['focus', 'cspdarknet'], ['cspdarknet', 'sppf'], ['sppf', 'pan'], ['pan', 'yolo_head'], ['yolo_head', 'nms'], ['nms', 'output']
    ],
    code: `import torch
...
# 前向传播
results = model(image)  # image: [B, 3, 640, 640]
# results 包含检测框、置信度、类别`,
    mermaid: `graph LR
    Input[Input 640x640] --> Focus[Focus]
    Focus --> Backbone[CSPDarknet]
    Backbone --> SPPF[SPPF]
    SPPF --> PAN[PAN+FPN]
    PAN --> Head[YOLO Head]
    Head --> NMS[NMS]
  ...
  'U-Net': {
    ...
    connections: [
      ['input', 'enc1'], ['enc1', 'enc2'], ['enc2', 'enc3'], ['enc3', 'enc4'], ['enc4', 'bottleneck'],
      ['bottleneck', 'dec4'], ['dec4', 'dec3'], ['dec3', 'dec2'], ['dec2', 'dec1'], ['dec1', 'output_conv'], ['output_conv', 'output'],
...
class UNet(nn.Module):
  ...
  'GPT-2': {
    ...
    blocks: [
      ...
      { id: 'decoder', type: 'custom', label: 'Transformer Decoder ×12', desc: '12 层 Decoder', icon: LUCIDE_ICONS['📚'],
        ...
        children: [
          { id: 'dec_ln1', type: 'norm', label: 'LayerNorm', desc: 'Pre-LN', detail: 'Pre-LayerNorm' },
          { id: 'dec_mha', type: 'attention', label: 'Masked Self-Attention', desc: '12头因果注意力', detail: '带因果掩码的自注意力，防止看到未来 token' },
          { id: 'dec_addnorm1', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + Attention(x))' },
          { id: 'dec_mlp', type: 'mlp', label: 'MLP', desc: 'Linear(3072) + GELU + Linear(768)', params: { in_f: 768, out_f: 3072, act: 'GELU' }, detail: '前馈网络：768 → 3072 → 768' },
          { id: 'dec_addnorm2', type: 'norm', label: 'Add & Norm', desc: '残差连接 + LayerNorm', detail: 'LayerNorm(x + MLP(x))' }
        ]},
      { id: 'final_ln', type: 'norm', label: 'Final LayerNorm', desc: 'LayerNorm', detail: '最终 LayerNorm' },
      { id: 'lm_head', type: 'linear', label: 'LM Head', desc: 'Linear(768, 50257)', params: { in_f: 768, out_f: 50257 }, detail: '语言模型头：投影到词表大小' },
      { id: 'softmax', type: 'activation', label: 'Softmax', desc: 'Softmax', detail: '输出概率分布' },
    ...
    connections: [
      ['input', 'token_embed'], ['token_embed', 'pos_embed'], ['pos_embed', 'dropout'], ['dropout', 'decoder'], ['decoder', 'final_ln'], ['final_ln', 'lm_head'], ['lm_head', 'softmax'], ['softmax', 'output']
    ],
...
with torch.no_grad():
    ...
    TokEmb --> PosEmb[Position Embedding]
    PosEmb --> Dropout[Dropout]
    Dropout --> Dec[Decoder x12]
    Dec --> FinalLN[Final LayerNorm]
  ...
  'GAN': {
    ...
    dataType: '图像',
    params: {
      latentDim: { label: '隐变量维度', min: 10, max: 512, default: 100, step: 10 },
      imageSize: { label: '生成图像尺寸', type: 'select', options: ['28', '64', '128', '256'], default: '64' },
      numChannels: { label: '图像通道数', type: 'select', options: ['1', '3'], default: '3' }
    },
    blocks: [
      { id: 'input', type: 'input', label: 'Input', desc: '随机噪声 z', detail: '从标准正态分布采样的隐变量 z ~ N(0, I)' },
      { id: 'generator', type: 'custom', label: 'Generator', desc: '生成器网络', icon: LUCIDE_ICONS['🎨'],
        detail: '将隐变量 z 映射为假图像，通过反卷积/上采样逐步增大空间分辨率',
        children: [
          { id: 'g_fc', type: 'linear', label: 'Linear', desc: 'Linear(latent_dim, 1024)', params: { in_f: 100, out_f: 1024 }, detail: '全连接层将噪声映射到特征空间' },
          { id: 'g_act1', type: 'activation', label: 'ReLU', desc: 'ReLU', detail: 'ReLU 激活' },
          { id: 'g_reshape', type: 'custom', label: 'Reshape', desc: 'reshape to 4×4×1024', icon: LUCIDE_ICONS['📊'], detail: '将向量重塑为 4×4×1024 特征图' },
          { id: 'g_deconv1', type: 'conv', label: 'Transposed Conv', desc: 'Deconv 512@4×4, stride 2', params: { in_ch: 1024, out_ch: 512, kernel: 4, stride: 2 }, detail: '反卷积上采样到 8×8' },
          { id: 'g_bn1', type: 'norm', label: 'BatchNorm', desc: 'BatchNorm2d(512)', detail: '批归一化' },
          { id: 'g_act2', type: 'activation', label: 'ReLU', desc: 'ReLU', detail: 'ReLU 激活' },
          { id: 'g_deconv2', type: 'conv', label: 'Transposed Conv', desc: 'Deconv 256@4×4, stride 2', params: { in_ch: 512, out_ch: 256, kernel: 4, stride: 2 }, detail: '反卷积上采样到 16×16' },
          { id: 'g_bn2', type: 'norm', label: 'BatchNorm', desc: 'BatchNorm2d(256)', detail: '批归一化' },
          { id: 'g_act3', type: 'activation', label: 'ReLU', desc: 'ReLU', detail: 'ReLU 激活' },
          { id: 'g_deconv3', type: 'conv', label: 'Transposed Conv', desc: 'Deconv 128@4×4, stride 2', params: { in_ch: 256, out_ch: 128, kernel: 4, stride: 2 }, detail: '反卷积上采样到 32×32' },
          { id: 'g_bn3', type: 'norm', label: 'BatchNorm', desc: 'BatchNorm2d(128)', detail: '批归一化' },
          { id: 'g_act4', type: 'activation', label: 'ReLU', desc: 'ReLU', detail: 'ReLU 激活' },
          { id: 'g_deconv4', type: 'conv', label: 'Transposed Conv', desc: 'Deconv 3@4×4, stride 2', params: { in_ch: 128, out_ch: 3, kernel: 4, stride: 2 }, detail: '反卷积上采样到 64×64，输出 RGB 图像' },
          { id: 'g_tanh', type: 'activation', label: 'Tanh', desc: 'Tanh', detail: 'Tanh 将输出归一化到 [-1, 1]' }
        ]},
      { id: 'fake_image', type: 'custom', label: 'Fake Image', desc: '生成的假图像', icon: LUCIDE_ICONS['🖼️'], detail: '生成器输出的假图像' },
      { id: 'discriminator', type: 'custom', label: 'Discriminator', desc: '判别器网络', icon: LUCIDE_ICONS['👁️'],
        detail: '判断输入图像是真实图像还是生成器生成的假图像',
        children: [
          { id: 'd_conv1', type: 'conv', label: 'Conv 64@4×4', desc: 'Conv 64@4×4, stride 2 + LeakyReLU', params: { in_ch: 3, out_ch: 64, kernel: 4, stride: 2, act: 'LeakyReLU' }, detail: '卷积下采样到 32×32' },
          { id: 'd_conv2', type: 'conv', label: 'Conv 128@4×4', desc: 'Conv 128@4×4, stride 2 + BN + LeakyReLU', params: { in_ch: 64, out_ch: 128, kernel: 4, stride: 2, norm: 'batch', act: 'LeakyReLU' }, detail: '卷积下采样到 16×16' },
          { id: 'd_conv3', type: 'conv', label: 'Conv 256@4×4', desc: 'Conv 256@4×4, stride 2 + BN + LeakyReLU', params: { in_ch: 128, out_ch: 256, kernel: 4, stride: 2, norm: 'batch', act: 'LeakyReLU' }, detail: '卷积下采样到 8×8' },
          { id: 'd_conv4', type: 'conv', label: 'Conv 512@4×4', desc: 'Conv 512@4×4, stride 2 + BN + LeakyReLU', params: { in_ch: 256, out_ch: 512, kernel: 4, stride: 2, norm: 'batch', act: 'LeakyReLU' }, detail: '卷积下采样到 4×4' },
          { id: 'd_flatten', type: 'custom', label: 'Flatten', desc: '展平', icon: LUCIDE_ICONS['📊'], detail: '展平为一维向量' },
          { id: 'd_fc', type: 'linear', label: 'Linear', desc: 'Linear(8192, 1)', params: { in_f: 8192, out_f: 1 }, detail: '全连接层输出判别分数' },
          { id: 'd_sigmoid', type: 'activation', label: 'Sigmoid', desc: 'Sigmoid', detail: 'Sigmoid 输出真假概率' }
        ]},
      { id: 'output', type: 'output', label: 'Output', desc: '判别概率', detail: '判别器输出图像为真的概率' }
    ],
    connections: [
      ['input', 'generator'], ['generator', 'fake_image'], ['fake_image', 'discriminator'], ['discriminator', 'output']
    ],
    code: `import torch
import torch.nn as nn
